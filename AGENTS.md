...
- demo asset manifest 当前 SHA=`4efa703588831e616a1a0c7e4d25b7332a1aac8f4d1ceee9bd41baabfc3ad32e`、`asset_count=64`；相关 PG388/前端/组合测试 `11 passed`（Transformer nested-tensor 仅为警告）。
- 前端已用最新 `.next/standalone` 做无外网 refresh image，当前 image=`sha256:1b3be1386149165a65871fabcc3aeba42b8fa19b63874081380e80d83549bbbd`；`/pg388` 和摘要接口复核 HTTP 200，摘要 latest candidate=`11-slot composition (full CPU)`、taxonomy case_count=66，B holdout 未启动。
- 前端摘要新增 taxonomy coverage projection：66 个抽象案例、10 个 04.13 类别、0 个缺失锚点、10 个 candidate-only 细项；只显示有界计数，原始行/业务值不进入浏览器。
- 前端运行时将后端 56 个核心合同与 10 个 supplemental contracts 合并进 case catalog，静态详解优先，其余只使用 ASK/抽象模板；taxonomy 面板对应最新摘要 SHA=`bf507f3baf6a98f797feb7d48f7e9174b1a771aee0b6293b108cbaa039f36615`、投影脚本 SHA=`09b722d742740ffc49bd52b913478711ed03c522de2ff574d53b264f663a4e3b`、组件 SHA=`843a4daba37110828c5cbfa4dda116ca6d6dde4b202b0bb9162a49084b84b48a`；Next build 通过，资产校验为 `asset_count=64`。
