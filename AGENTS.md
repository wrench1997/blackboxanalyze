...
- 固定 digest backend image=`sha256:03aadf776c1aeb315ba64fff524c0cf53d18ca017c53f007515cd9cbd70abe36`，backend source SHA=`a38be42a2792b0114be393c5e0c9f12dcf7023be390a4b4d874484d50d615a6f`；`/pg388` 页面仍 HTTP 200。所有数据仍 `training_eligible=0`，raw/evaluator answer、training、memory、payload catalog、vulnerability promotion 全部关闭。规则文件 SHA=`999b14bcb102c2f0dabb75c3916d64380a98f2f78c1183064d12df9c5b9cdf87`，asset manifest SHA=`f9b43b5d96d41d6fb4dc579137ec045b7e7fc37ef432e14d9cd644af1b8217fa`。
