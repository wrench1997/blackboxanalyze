...
def test_pg71_v2_keeps_candidate_evaluation_only_after_known_holdout_failure():
    report = _read("pg71_trace_abstention_head_v2_report_v1.json")
...
def test_pg71_v2_trace_has_no_raw_probe_or_response_persistence():
    trace = _read("pg71_trace_abstention_head_v2_trace_v1.json")
