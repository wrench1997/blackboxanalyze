...
CASES = {
    ...
    "oauth_second_factor": {"surface": "oauth_second_factor", "invariant": "oauth_requires_second_factor", "repair": "order"},
    "activation_link_second_factor": {"surface": "activation_second_factor", "invariant": "activation_does_not_skip_factor", "repair": "order"},
    "csrf_disable_second_factor": {"surface": "factor_settings_csrf", "invariant": "factor_disable_requires_csrf", "repair": "binding"},
    "captcha_reuse": {"surface": "captcha_state", "invariant": "challenge_consumed_once", "repair": "replay"},
    "captcha_predictability": {"surface": "captcha_entropy", "invariant": "challenge_value_not_predictable", "repair": "entropy"},
    "captcha_response_exposure": {"surface": "captcha_response", "invariant": "challenge_value_not_returned", "repair": "redaction"},
    "captcha_client_validation": {"surface": "captcha_validation", "invariant": "challenge_validation_is_server_owned", "repair": "authority"},
    "captcha_delivery_abuse": {"surface": "captcha_delivery", "invariant": "challenge_delivery_is_rate_limited", "repair": "boundary"},
    "session_fixation_boundary": {"surface": "session_rotation", "invariant": "session_rotates_after_auth", "repair": "rotation"},
    "session_guessing": {"surface": "session_entropy", "invariant": "session_identifier_not_predictable", "repair": "entropy"},
    "session_forgery": {"surface": "session_integrity", "invariant": "session_state_integrity_bound", "repair": "binding"},
    "session_leakage": {"surface": "session_exposure", "invariant": "session_secret_not_projected", "repair": "redaction"},
